...
<div class="container-fluid py-4">
    ...
    <x-page-description icon="bi-journal-plus">
        <strong>{{ __('app.create_subject_page_title') }}</strong><br>
        {{ __('app.create_subject_page_description') }}
    </x-page-description>

    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card form-card shadow-hover">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="mb-0">{{ __('app.create_new_subject') }}</h5>
                            <small class="text-white-50">{{ __('app.fill_all_required_fields') }}</small>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                <form id="createSubjectForm" method="POST" action="{{ route('subjects.store') }}">
                    ...
                    <div class="form-section">
                        ...
                        <!-- Keywords -->
                        <div class="mb-4">
                            <label for="keywords" class="form-label required">
                                <i class="bi bi-tags"></i>
                                {{ __('app.keywords') }}
                            </label>
                            <textarea class="form-control form-control-lg @error('keywords') is-invalid @enderror"
                                      id="keywords"
                                      name="keywords"
                                      rows="3"
                                      required
                        ...
                        <!-- Tools -->
                        <div class="mb-4">
                            <label for="tools" class="form-label required">
                                <i class="bi bi-gear"></i>
                                {{ __('app.tools_technologies') }}
                            </label>
                            <textarea class="form-control form-control-lg @error('tools') is-invalid @enderror"
                                      id="tools"
                                      name="tools"
                                      rows="3"
                                      required
                        ...
                        <!-- Plan -->
                        <div class="mb-4">
                            <label for="plan" class="form-label required">
                                <i class="bi bi-diagram-3"></i>
                                {{ __('app.project_plan') }}
                            </label>
                            <textarea class="form-control form-control-lg @error('plan') is-invalid @enderror"
                                      id="plan"
                                      name="plan"
                                      rows="6"
                                      required
                    ...
                    <div class="form-section">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <a href="{{ route('subjects.index') }}" class="btn btn-lg btn-secondary">
                                <i class="bi bi-arrow-left"></i>
                                {{ __('app.cancel') }}
                            </a>
                            <div class="d-flex gap-3">
                                @if(auth()->user()->role === 'teacher')
                                    <button type="submit" name="action" value="draft" class="btn btn-lg btn-outline-primary">
                                        <i class="bi bi-file-earmark"></i>
                                        {{ __('app.save_as_draft') }}
                                    </button>
                                    <button type="submit" name="action" value="submit" class="btn btn-lg btn-primary">
                                ...
                                @else
                                    ...
                                    <button type="submit" name="action" value="submit" class="btn btn-lg btn-success">
                                        <i class="bi bi-send-check-fill"></i>
                                        {{ __('app.submit_for_validation') }}
                                    </button>
                                @endif
                            </div>
                        </div>
