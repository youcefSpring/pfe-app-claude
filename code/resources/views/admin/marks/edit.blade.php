                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('subject_name') is-invalid @enderror"
                                           id="subject_name" name="subject_name" value="{{ old('subject_name', $mark->subject_name) }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('semester') is-invalid @enderror" id="semester" name="semester">
                                        ...
                                        <option value="S1" {{ old('semester', $mark->semester) == 'S1' ? 'selected' : '' }}>S1</option>
                                        <option value="S2" {{ old('semester', $mark->semester) == 'S2' ? 'selected' : '' }}>S2</option>
                                        <option value="S3" {{ old('semester', $mark->semester) == 'S3' ? 'selected' : '' }}>S3</option>
                                        <option value="S4" {{ old('semester', $mark->semester) == 'S4' ? 'selected' : '' }}>S4</option>
                                        <option value="S5" {{ old('semester', $mark->semester) == 'S5' ? 'selected' : '' }}>S5</option>
                                        <option value="S6" {{ old('semester', $mark->semester) == 'S6' ? 'selected' : '' }}>S6</option>
                                    </select>
                                    @error('semester')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('academic_year') is-invalid @enderror" id="academic_year" name="academic_year" required>
                                        ...
                                        @for($year = $currentYear - 2; $year <= $currentYear + 1; $year++)
                                            ...
                                            <option value="{{ $academicYear }}" {{ old('academic_year', $mark->academic_year) == $academicYear ? 'selected' : '' }}>
                                                {{ $academicYear }}
                                            </option>
                                        @endfor
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="1" max="100"
                                           ...
                                           id="max_mark" name="max_mark" value="{{ old('max_mark', $mark->max_mark) }}" required>
                                    @error('max_mark')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror"
                                              ...
                                              placeholder="{{ __('app.additional_notes_optional') }}">{{ old('notes', $mark->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
